...
import TraceAnalysis.service.ArticleService;
...
public class ArticleServiceController {
    ...
    public ResponseEntity<?> submitNewArticle(
        ...
        List<Author> authorArgument = generateAuthor(authors);
    ...
    private List<Author> generateAuthor(String authors) {
...
//        return authorArgument;
        return JSONArray.parseArray(authors, Author.class);
    }
