...
public class JwtTokenUtil implements Serializable {
    ...
    private userauth.security.jwt.JwtConfigProperties jwtConfigProperties;

    public JwtTokenUtil(userauth.security.jwt.JwtConfigProperties jwtConfigProperties) {
